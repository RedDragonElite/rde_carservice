...
Config.Translations = {
    ['en'] = {
        ...
        ['calling_pickup'] = 'Calling pickup...',
        ['driver_arriving_seconds'] = 'Driver arriving in ~%d seconds',
        ['driver_almost_here'] = 'Driver is almost here!',
        ['vehicle_delivered'] = '✅ Vehicle delivered successfully!',
        ['driver_on_way_pickup'] = 'Driver en route to pickup',
        ['request_delivery_desc'] = 'Deliver vehicle to your location for $%d',
        ['request_pickup_desc'] = '💾 Store vehicle in garage for $%d',
        ['plate_cost_desc'] = '📋 Plate: %s | 💵 Cost: $%d',
        ['service_requested_short'] = 'Service requested',
        ['pickup_requested_short'] = 'Pickup requested',
        ['no_vehicles_in_garage'] = 'No vehicles in garage',
        ['no_vehicle_nearby'] = 'No vehicle nearby',
        ['invalid_vehicle_model'] = 'Invalid vehicle model',
        ['menu_title_short'] = '🚘 Car Service Menu',
        ['request_pickup_title'] = '📞 Request Pickup',
        -- Error keys (server result codes)
        ['player_not_found'] = 'Player not found',
        ['account_error'] = 'Payment error',
        ['vehicle_not_stored'] = 'Vehicle not in garage',
    ...
    ['de'] = {
        ...
        -- Additional UI Strings
        ['calling_service'] = 'Rufe Service an...',
        ['calling_pickup'] = 'Rufe Abholung an...',
        ['driver_arriving_seconds'] = 'Fahrer kommt in ~%d Sekunden an',
        ['driver_almost_here'] = 'Fahrer ist gleich da!',
        ['vehicle_delivered'] = '✅ Fahrzeug erfolgreich geliefert!',
        ['driver_on_way_pickup'] = 'Fahrer ist unterwegs zur Abholung',
        ['request_delivery_desc'] = 'Fahrzeug für $%d zu dir liefern',
        ['request_pickup_desc'] = '💾 Fahrzeug in Garage lagern für $%d',
        ['plate_cost_desc'] = '📋 Kennzeichen: %s | 💵 Kosten: $%d',
        ['service_requested_short'] = 'Service angefordert',
        ['pickup_requested_short'] = 'Abholung angefordert',
        ['no_vehicles_in_garage'] = 'Keine Fahrzeuge in der Garage',
        ['no_vehicle_nearby'] = 'Kein Fahrzeug in der Nähe',
        ['invalid_vehicle_model'] = 'Ungültiges Fahrzeugmodell',
        ['menu_title_short'] = '🚘 Car Service Menü',
        ['request_pickup_title'] = '📞 Abholung anfordern',
        -- Error keys (server result codes)
